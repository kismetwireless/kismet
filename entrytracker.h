...
public:
    ...
    // Reserve a field name, include a builder instance of the field instead of a fixed type.
    // Used for building complex types w/ storage backed by trackable elements.
    ...
    // Reserve a field name, and return an instance.  If the field ALREADY EXISTS, return
    // an instance.
    TrackerElement *RegisterAndGetField(string in_name, TrackerElement *in_builder, string in_desc);
