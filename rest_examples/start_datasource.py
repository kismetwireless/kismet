...
(r, v) = kr.get_url("datasource/by-uuid/{}/open_source.cmd".format(results.uuid))

if r:
    print "Source restarted successfully: ", v
else:
    print "Error restarting source - check Kismet messages"
