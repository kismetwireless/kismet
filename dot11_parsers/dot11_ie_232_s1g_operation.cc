...
void dot11_s1g_operation::parse(const std::string_view *view) {
    ...
    m_opclass = p_io.read_u1();
    m_primary = p_io.read_u1();
    m_channel_center = p_io.read_u1();
    m_mcs_nss_set = p_io.read_u2be();
