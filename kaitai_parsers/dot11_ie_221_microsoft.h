#ifndef DOT11_IE_221_MICROSOFT_H_
#define DOT11_IE_221_MICROSOFT_H_
...
class dot11_ie_221_microsoft_t : public kaitai::kstruct {
...
public:
    ...
    dot11_ie_221_microsoft_t(kaitai::kstream* p_io, kaitai::kstruct* p_parent = 0, dot11_ie_221_microsoft_t* p_root = 0);
    ~dot11_ie_221_microsoft_t();

    class wps_de_uuid_e_t : public kaitai::kstruct {

    public:

        wps_de_uuid_e_t(kaitai::kstream* p_io, dot11_ie_221_microsoft_t::wps_de_element_t* p_parent = 0, dot11_ie_221_microsoft_t* p_root = 0);
        ~wps_de_uuid_e_t();

    private:
        std::string m_uuid_e;
        dot11_ie_221_microsoft_t* m__root;
        dot11_ie_221_microsoft_t::wps_de_element_t* m__parent;
    ...
    public:
        ...
        wps_de_version_t(kaitai::kstream* p_io, dot11_ie_221_microsoft_t::wps_de_element_t* p_parent = 0, dot11_ie_221_microsoft_t* p_root = 0);
        ~wps_de_version_t();
    ...
    class vendor_ms_wps_t : public kaitai::kstruct {

    public:

        vendor_ms_wps_t(kaitai::kstream* p_io, dot11_ie_221_microsoft_t* p_parent = 0, dot11_ie_221_microsoft_t* p_root = 0);
        ~vendor_ms_wps_t();
    ...
    public:
        ...
        wps_de_state_t(kaitai::kstream* p_io, dot11_ie_221_microsoft_t::wps_de_element_t* p_parent = 0, dot11_ie_221_microsoft_t* p_root = 0);
        ~wps_de_state_t();
    ...
    public:
        ...
        wps_de_vendor_extension_t(kaitai::kstream* p_io, dot11_ie_221_microsoft_t::wps_de_element_t* p_parent = 0, dot11_ie_221_microsoft_t* p_root = 0);
    ...
    public:
        ...
        wps_de_generic_t(kaitai::kstream* p_io, kaitai::kstruct* p_parent = 0, dot11_ie_221_microsoft_t* p_root = 0);
        ~wps_de_generic_t();
    ...
    public:
        ...
        wps_de_rfband_t(kaitai::kstream* p_io, dot11_ie_221_microsoft_t::wps_de_element_t* p_parent = 0, dot11_ie_221_microsoft_t* p_root = 0);
        ~wps_de_rfband_t();
    ...
    public:
        ...
        vendor_data_generic_t(kaitai::kstream* p_io, kaitai::kstruct* p_parent = 0, dot11_ie_221_microsoft_t* p_root = 0);
    ...
    public:
        ...
        wps_de_element_t(kaitai::kstream* p_io, dot11_ie_221_microsoft_t::vendor_ms_wps_t* p_parent = 0, dot11_ie_221_microsoft_t* p_root = 0);
        ~wps_de_element_t();
    ...
    private:
        ...
        dot11_ie_221_microsoft_t* m__root;
        dot11_ie_221_microsoft_t::vendor_ms_wps_t* m__parent;
    ...
    public:
        ...
        dot11_ie_221_microsoft_t* _root() const { return m__root; }
        dot11_ie_221_microsoft_t::vendor_ms_wps_t* _parent() const { return m__parent; }
    ...
    public:
        ...
        wps_de_ap_setup_t(kaitai::kstream* p_io, dot11_ie_221_microsoft_t::wps_de_element_t* p_parent = 0, dot11_ie_221_microsoft_t* p_root = 0);
        ~wps_de_ap_setup_t();
...
private:
    ...
    kaitai::kstream* m__io__raw_vendor_data;
...
public:
    ...
    kaitai::kstream* _io__raw_vendor_data() const { return m__io__raw_vendor_data; }
};

#endif  // DOT11_IE_221_MICROSOFT_H_
