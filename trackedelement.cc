...
TrackerElement& TrackerElement::operator+=(float& v) {
    switch (type) {
        case TrackerFloat:
            float_value+= v;
            break;
...
TrackerElement& TrackerElement::operator+=(double& v) {
    switch (type) {
        case TrackerFloat:
            float_value+= v;
            break;
...
TrackerElement& TrackerElement::operator+=(int& v) {
    switch (type) {
        case TrackerInt8:
            int8_value += v;
            break;
...
TrackerElement& TrackerElement::operator+=(unsigned int& v) {
    switch (type) {
        case TrackerInt8:
            int8_value += v;
            break;
