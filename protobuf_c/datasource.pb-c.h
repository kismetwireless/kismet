...
typedef struct _KismetDatasource__SubChannels KismetDatasource__SubChannels;
typedef struct _KismetDatasource__SubChanset KismetDatasource__SubChanset;
typedef struct _KismetDatasource__SubChanhop KismetDatasource__SubChanhop;
typedef struct _KismetDatasource__SubGps KismetDatasource__SubGps;
typedef struct _KismetDatasource__SubInterface KismetDatasource__SubInterface;
typedef struct _KismetDatasource__SubMsgbus KismetDatasource__SubMsgbus;
typedef struct _KismetDatasource__SubPacket KismetDatasource__SubPacket;
typedef struct _KismetDatasource__SubSignal KismetDatasource__SubSignal;
typedef struct _KismetDatasource__SubSpecset KismetDatasource__SubSpecset;
typedef struct _KismetDatasource__SubSpectrum KismetDatasource__SubSpectrum;
typedef struct _KismetDatasource__SubSuccess KismetDatasource__SubSuccess;
typedef struct _KismetDatasource__Channels KismetDatasource__Channels;
typedef struct _KismetDatasource__CloseDatasource KismetDatasource__CloseDatasource;
typedef struct _KismetDatasource__Configure KismetDatasource__Configure;
typedef struct _KismetDatasource__ConfigureReport KismetDatasource__ConfigureReport;
typedef struct _KismetDatasource__DataReport KismetDatasource__DataReport;
typedef struct _KismetDatasource__ErrorReport KismetDatasource__ErrorReport;
typedef struct _KismetDatasource__ListInterfaces KismetDatasource__ListInterfaces;
typedef struct _KismetDatasource__InterfacesReport KismetDatasource__InterfacesReport;
typedef struct _KismetDatasource__Message KismetDatasource__Message;
typedef struct _KismetDatasource__NewSource KismetDatasource__NewSource;
typedef struct _KismetDatasource__OpenSource KismetDatasource__OpenSource;
typedef struct _KismetDatasource__OpenSourceReport KismetDatasource__OpenSourceReport;
typedef struct _KismetDatasource__ProbeSource KismetDatasource__ProbeSource;
typedef struct _KismetDatasource__ProbeSourceReport KismetDatasource__ProbeSourceReport;
 ...
 */
typedef enum _KismetDatasource__SubMsgbus__MessageType {
  KISMET_DATASOURCE__SUB_MSGBUS__MESSAGE_TYPE__DEBUG = 1,
  KISMET_DATASOURCE__SUB_MSGBUS__MESSAGE_TYPE__INFO = 2,
  KISMET_DATASOURCE__SUB_MSGBUS__MESSAGE_TYPE__ERROR = 4,
  KISMET_DATASOURCE__SUB_MSGBUS__MESSAGE_TYPE__ALERT = 8,
  KISMET_DATASOURCE__SUB_MSGBUS__MESSAGE_TYPE__FATAL = 16
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(KISMET_DATASOURCE__SUB_MSGBUS__MESSAGE_TYPE)
 ...
 * Multiple channels
 */
struct  _KismetDatasource__SubChannels
{
 ...
 * Single channel
 */
struct  _KismetDatasource__SubChanset
{
  ProtobufCMessage base;
  char *channel;
};
 ...
 */
struct  _KismetDatasource__SubChanhop
{
  ProtobufCMessage base;
  /*
 ...
 * GPS data
 */
struct  _KismetDatasource__SubGps
{
  ProtobufCMessage base;
  double lat;
  double lon;
 ...
 * Possible interface
 */
struct  _KismetDatasource__SubInterface
{
  ProtobufCMessage base;
  char *interface;
  char *flags;
 ...
 */
struct  _KismetDatasource__SubMsgbus
{
  ProtobufCMessage base;
  KismetDatasource__SubMsgbus__MessageType msgtype;
  char *msgtext;
};
#define KISMET_DATASOURCE__SUB_MSGBUS__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&kismet_datasource__sub_msgbus__descriptor) \
    , 0, NULL }
 ...
 * Packetized data
 */
struct  _KismetDatasource__SubPacket
{
  ProtobufCMessage base;
  uint64_t time_sec;
  uint64_t time_usec;
 ...
 * Signal metadata
 */
struct  _KismetDatasource__SubSignal
{
  ProtobufCMessage base;
 ...
 */
struct  _KismetDatasource__SubSpecset
{
  ProtobufCMessage base;
 ...
 * Spectrum report
 */
struct  _KismetDatasource__SubSpectrum
{
  ProtobufCMessage base;
 ...
 * Command success
 */
struct  _KismetDatasource__SubSuccess
{
  ProtobufCMessage base;
 ...
 */
struct  _KismetDatasource__Channels
{
  ProtobufCMessage base;
  KismetDatasource__SubChannels *channels;
};
#define KISMET_DATASOURCE__CHANNELS__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&kismet_datasource__channels__descriptor) \
    , NULL }
 ...
 */
struct  _KismetDatasource__CloseDatasource
{
  ProtobufCMessage base;
};
 ...
 */
struct  _KismetDatasource__Configure
{
  ProtobufCMessage base;
 ...
 */
struct  _KismetDatasource__ConfigureReport
{
  ProtobufCMessage base;
 ...
 */
struct  _KismetDatasource__DataReport
{
  ProtobufCMessage base;
 ...
 */
struct  _KismetDatasource__ErrorReport
{
  ProtobufCMessage base;
  KismetDatasource__SubSuccess *success;
  KismetDatasource__SubMsgbus *message;
 ...
 */
struct  _KismetDatasource__ListInterfaces
{
  ProtobufCMessage base;
};
 ...
 */
struct  _KismetDatasource__InterfacesReport
{
  ProtobufCMessage base;
  KismetDatasource__SubSuccess *success;
  KismetDatasource__SubMsgbus *message;
 ...
 */
struct  _KismetDatasource__Message
{
  ProtobufCMessage base;
  KismetDatasource__SubMsgbus *message;
  char *warning;
};
#define KISMET_DATASOURCE__MESSAGE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&kismet_datasource__message__descriptor) \
    , NULL, NULL }
 ...
 */
struct  _KismetDatasource__NewSource
{
  ProtobufCMessage base;
  char *definition;
  char *sourcetype;
 ...
 */
struct  _KismetDatasource__OpenSource
{
  ProtobufCMessage base;
  char *definition;
};
 ...
 */
struct  _KismetDatasource__OpenSourceReport
{
  ProtobufCMessage base;
  KismetDatasource__SubSuccess *success;
  ...
  char *hardware;
  KismetDatasource__SubMsgbus *message;
  KismetDatasource__SubSpecset *specset;
  char *uuid;
  char *warning;
};
 ...
 */
struct  _KismetDatasource__ProbeSource
{
  ProtobufCMessage base;
  char *definition;
};
 ...
 */
struct  _KismetDatasource__ProbeSourceReport
{
  ProtobufCMessage base;
  KismetDatasource__SubSuccess *success;
  KismetDatasource__SubMsgbus *message;
  KismetDatasource__SubChannels *channels;
  KismetDatasource__SubChanset *chanset;
  KismetDatasource__SubSpecset *specset;
  char *hardware;
};
...
void   kismet_datasource__sub_interface__free_unpacked
                     (KismetDatasource__SubInterface *message,
                      ProtobufCAllocator *allocator);
/* KismetDatasource__SubMsgbus methods */
...
void   kismet_datasource__sub_success__free_unpacked
                     (KismetDatasource__SubSuccess *message,
                      ProtobufCAllocator *allocator);
/* KismetDatasource__Channels methods */
...
void   kismet_datasource__interfaces_report__free_unpacked
                     (KismetDatasource__InterfacesReport *message,
                      ProtobufCAllocator *allocator);
/* KismetDatasource__Message methods */
...
typedef void (*KismetDatasource__SubInterface_Closure)
                 (const KismetDatasource__SubInterface *message,
                  void *closure_data);
typedef void (*KismetDatasource__SubMsgbus_Closure)
                 (const KismetDatasource__SubMsgbus *message,
                  void *closure_data);
...
typedef void (*KismetDatasource__SubSuccess_Closure)
                 (const KismetDatasource__SubSuccess *message,
                  void *closure_data);
typedef void (*KismetDatasource__Channels_Closure)
                 (const KismetDatasource__Channels *message,
                  void *closure_data);
...
typedef void (*KismetDatasource__InterfacesReport_Closure)
                 (const KismetDatasource__InterfacesReport *message,
                  void *closure_data);
typedef void (*KismetDatasource__Message_Closure)
                 (const KismetDatasource__Message *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor kismet_datasource__sub_msgbus__descriptor;
extern const ProtobufCEnumDescriptor    kismet_datasource__sub_msgbus__message_type__descriptor;
...
extern const ProtobufCMessageDescriptor kismet_datasource__channels__descriptor;
...
extern const ProtobufCMessageDescriptor kismet_datasource__message__descriptor;
