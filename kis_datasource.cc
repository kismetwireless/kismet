...
void kis_datasource::list_interfaces(unsigned int in_transaction, list_callback_t in_cb) {
    kis_unique_lock<kis_shared_mutex> lock(ext_mutex, std::defer_lock, "datasource list_interfaces");
    lock.lock();
...
void kis_datasource::probe_interface(std::string in_definition, unsigned int in_transaction,
    ...
    kis_unique_lock<kis_shared_mutex> lock(ext_mutex, std::defer_lock, "datasource probe_interface");
    lock.lock();
...
void kis_datasource::open_interface(std::string in_definition, unsigned int in_transaction, 
    ...
    kis_unique_lock<kis_shared_mutex> lock(ext_mutex, std::defer_lock, "datasource open_interface");
    lock.lock();
    ...
    ping_timer_id = timetracker->register_timer(std::chrono::seconds(5), true, [this](int) -> int {
        kis_lock_guard<kis_shared_mutex> lk(ext_mutex, "datasource ping_timer lambda");
...
void kis_datasource::set_channel(std::string in_channel, unsigned int in_transaction,
    ...
    kis_unique_lock<kis_shared_mutex> lock(ext_mutex, std::defer_lock, "datasource set_channel");
    lock.lock();
...
void kis_datasource::set_channel_hop(double in_rate, std::vector<std::string> in_chans,
        ...
        configure_callback_t in_cb) {
    kis_lock_guard<kis_shared_mutex> lk(ext_mutex, "datasource set_channel_hop");
...
void kis_datasource::connect_remote(std::string in_definition, kis_datasource* in_remote, 
    ...
    kis_lock_guard<kis_shared_mutex> lk(ext_mutex, "datasource connect_remote");
...
void kis_datasource::disable_source() {
    kis_lock_guard<kis_shared_mutex> lk(ext_mutex, "datasource disable_source");
...
void kis_datasource::pause_source() {
    kis_lock_guard<kis_shared_mutex> lk(ext_mutex, "datasource pause_source");
...
void kis_datasource::close_external() {
    kis_lock_guard<kis_shared_mutex> lk(ext_mutex, "datasource close_external");
...
bool kis_datasource::parse_interface_definition(std::string in_definition) {
    kis_lock_guard<kis_shared_mutex> lk(ext_mutex, "datasource parse_interface");
...
void kis_datasource::cancel_command(uint32_t in_transaction, std::string in_error) {
    kis_lock_guard<kis_shared_mutex> lk(ext_mutex, "datasource cancel_command");
...
void kis_datasource::cancel_all_commands(std::string in_error) {
    kis_lock_guard<kis_shared_mutex> lk(ext_mutex, "datasource cancel_all_commands");
...
void kis_datasource::handle_packet_probesource_report(uint32_t in_seqno, 
    ...
    kis_unique_lock<kis_shared_mutex> lock(ext_mutex, std::defer_lock, 
...
void kis_datasource::handle_packet_interfaces_report(uint32_t in_seqno, 
        const std::string& in_content) {
    kis_unique_lock<kis_shared_mutex> lock(ext_mutex, std::defer_lock, "datasource handle_packet_interfaces_report");
    lock.lock();
...
void kis_datasource::handle_packet_error_report(uint32_t in_seqno, const std::string& in_content) {
    kis_lock_guard<kis_shared_mutex> lk(ext_mutex, "datasource handle_packet_error_report");
...
void kis_datasource::handle_packet_configure_report(uint32_t in_seqno, const std::string& in_content) {
    kis_unique_lock<kis_shared_mutex> lock(ext_mutex, std::defer_lock, "datasource handle_packet_configure_report");
    lock.lock();
...
void kis_datasource::handle_packet_data_report(uint32_t in_seqno, const std::string& in_content) {
    ...
    {
        kis_lock_guard<kis_shared_mutex> lk(ext_mutex, "datasource handle_packet_data_report");
...
void kis_datasource::handle_packet_warning_report(uint32_t in_seqno, const std::string& in_content) {
    kis_lock_guard<kis_shared_mutex> lk(ext_mutex, "datasource handle_packet_warning_report");
...
unsigned int kis_datasource::send_probe_source(std::string in_definition,
    ...
    kis_lock_guard<kis_shared_mutex> lk(ext_mutex, "datasource send_probe_source");
...
unsigned int kis_datasource::send_open_source(std::string in_definition,
    ...
    kis_lock_guard<kis_shared_mutex> lk(ext_mutex, "datasource send_open_source");
...
unsigned int kis_datasource::send_configure_channel(std::string in_chan,
        unsigned int in_transaction, configure_callback_t in_cb) {
    kis_lock_guard<kis_shared_mutex> lk(ext_mutex, "datasource send_configure_channel");
...
unsigned int kis_datasource::send_configure_channel_hop(double in_rate, 
    ...
    kis_lock_guard<kis_shared_mutex> lk(ext_mutex, "datasource send_configure_channel_hop");
...
unsigned int kis_datasource::send_list_interfaces(unsigned int in_transaction, list_callback_t in_cb) {
    kis_lock_guard<kis_shared_mutex> lk(ext_mutex, "datasource send_list_interfaces");
...
void kis_datasource::handle_source_error() {
    kis_lock_guard<kis_shared_mutex> lk(ext_mutex, "datasouce handle_source_error");
    ...
    if (error_timer_id <= 0) {
        ...
        error_timer_id = timetracker->register_timer(std::chrono::seconds(5), false, [this](int) -> int {
                kis_lock_guard<kis_shared_mutex> lk(ext_mutex, "datasource error_timer lambda");
