...
bool kis_gps_meta::open_gps(std::string in_opts) {
    kis_lock_guard<kis_mutex> lk(gps_mutex, "gps_meta open_gps");

    if (!kis_gps::open_gps(in_opts)) {
        return false;
    }

    set_int_gps_description("meta gps");
...
bool kis_gps_meta::get_location_valid() {
    kis_lock_guard<kis_mutex> lk(data_mutex, "gps_meta get_location_valid");
...
bool kis_gps_meta::get_device_connected() {
    kis_lock_guard<kis_mutex> lk(data_mutex, "gps_meta get_device_connected");
