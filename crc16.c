...
/* Tony Cheneau <tony.cheneau@nist.gov>
 ...
 The following test value is the only one provided by the standard:
static uint8_t test_vec [3] = { 0x40, 0x00, 0x56 };
static uint16_t test_crc = 0x279E;
*/
...
/* following code public domain
 * it's slightly modified from the original from J. Zbiciak (2001) to use
 * standard types + reflected table   */
