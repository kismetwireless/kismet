...
void ipc_tracker_v2::register_ipc(const kis_ipc_record& ipc) {
    local_locker l(&mutex, "ipc_tracker_v2::register_ipc");
...
void ipc_tracker_v2::remove_ipc(pid_t pid) {
    local_locker l(&mutex, "ipc_tracker_v2::remove_ipc");
...
void ipc_tracker_v2::soft_kill_all() {
    local_locker l(&mutex, "ipc_tracker_v2::soft_kill_all");
...
void ipc_tracker_v2::hard_kill_all() {
    local_locker l(&mutex, "ipc_tracker_v2::hard_kill_all");
