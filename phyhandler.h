...
public:
	...
	constexpr17 int fetch_phy_id() { return phyid; }
    constexpr17 uint32_t fetch_phyname_hash() { return phyname_hash; }
    device_key make_key(const mac_addr& mac) { return device_key(phyname_hash, mac); }
