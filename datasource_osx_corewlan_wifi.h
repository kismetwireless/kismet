...
public:
    KisDatasourceOsxCorewlanWifi(GlobalRegistry *in_globalreg, 
...
public:
    DatasourceOsxCorewlanWifiBuilder(GlobalRegistry *in_globalreg, int in_id) :
    ...
    DatasourceOsxCorewlanWifiBuilder(GlobalRegistry *in_globalreg) :
    ...
    virtual SharedDatasource build_datasource(SharedDatasourceBuilder in_sh_this) {
        return SharedDatasourceOsxCorewlanWifi(new KisDatasourceOsxCorewlanWifi(globalreg, 
                    in_sh_this));
    }
