...
public:
    ...
    void add_sample(int64_t in_s, time_t in_time) {
        kis_lock_guard<kis_shared_mutex> lk(mutex, "kis_tracked_rrd add_sample");
    ...
    virtual void pre_serialize() override {
        mutex.lock("kis_tracked_rrd preserialize");
...
public:
    ...
    void add_sample(int64_t in_s, time_t in_time) {
        kis_lock_guard<kis_shared_mutex> lk(mutex, "kis_tracked_minute_rrd add_sample");
    ...
    virtual void pre_serialize() override {
        mutex.lock("kis_tracked_minute_rrd pre_serialize");
        tracker_component::pre_serialize();
        Aggregator agg;
