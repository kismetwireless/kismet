...
/* Adapted directly form wireshark packet_bluetooth's pre-indexed list */
const std::unordered_map<uint16_t, std::string> bluetooth_uuid_ids = {
...
/* Adapted directly from wiresharks pre-formatted data */
const std::unordered_map<uint16_t, std::string> bluetooth_company_ids = {
